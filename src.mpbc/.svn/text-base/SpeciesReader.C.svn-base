...
//
////////////////////////////////////////////////////////////////////////////////
// $Id: SpeciesReader.C,v 1.11 2008/09/08 15:56:19 fgygi Exp $
...
void SpeciesReader::bcastSpecies(Species& sp)
{
  ...
  if ( ctxt_.onpe0() )
  {
    ...
    ctxt_.ibcast_send(1,1,(int*)&sp.lmax_,1);
    ctxt_.ibcast_send(1,1,(int*)&sp.llocal_,1);
  ...
  else
  {
    ...
    ctxt_.ibcast_recv(1,1,(int*)&sp.lmax_,1,0,0);
    ctxt_.ibcast_recv(1,1,(int*)&sp.llocal_,1,0,0);
