...
class Species
{
  ...
  unsigned lmax_;           // largest angular momentum
  unsigned llocal_;         // angular momentum taken as local
  ...
  unsigned lmax(void) const { return lmax_; }
  ...
  void phi(unsigned l, double r, double &val);              // phi(l,r) in r space
  void vpsr(unsigned l, double r, double &v);               // Vps(l,r) in r space
  void dvpsr(unsigned l, double r, double &v, double &dv);  // Vps and dVps/dr
  void vlocg(double q, double &v);                     // Vloc(g)
  void dvlocg(double q, double &v, double &dv);        // Vloc(g) and dVloc/dg
  void vnlg(unsigned l, double q, double &v);               // Vnl(l,g)
  void dvnlg(unsigned l, double q, double &v, double &dv);  // Vnl(l,g) and dVnl/dg
