...
//
////////////////////////////////////////////////////////////////////////////////
// $Id: StructureFactor.C,v 1.6 2008/09/08 15:56:19 fgygi Exp $

#include "StructureFactor.h"
#include "Basis.h"
#include "UnitCell.h"
#include <cassert>
#include <cstring> //alf: added for gcc4.3
using namespace std;
  ...
  const Basis& basis)
{
  ...
  for ( unsigned is = 0; is < _nsp; is++ )
  {
    ...
    for ( unsigned ia = 0; ia < _na[is]; ia++ )
    {
