...
/*3*/ 	struct reduced_planck_constant_base_unit : base_unit<reduced_planck_constant_base_unit, 
	...
	>{
 		...
 		static string symbol() {return ("\\mathit{\\hbar}");} // ℏ
 	};
	//electric constant
	...
	>{
 		...
 		static string symbol() {
			return 
				//"1/(4 � �₀)"// wiki friendly unicode // not friendly with acrobat annotations
...
namespace atomic{
	...
	inline string symbol_string(const reduce_unit<time>::type&                   ){return "ℏ/E_h";                     }
	...
	inline string symbol_string(const reduce_unit<length>::type&                 ){return "a_0"; /*"a₀";*/             }
	inline string name_string  (const reduce_unit<volume>::type&                 ){return "atomic unit of volume";     } 
	inline string symbol_string(const reduce_unit<volume>::type&                 ){return symbol_string(reduce_unit<length>::type()) + "^3"  /*"a₀^3"*/;                 }
	inline string name_string  (const reduce_unit<number_density>::type&         ){return "atomic unit of number density";}
	inline string symbol_string(const reduce_unit<number_density>::type&         ){return symbol_string(reduce_unit<length>::type()) + "^-3" /*"a₀^{-3}"*/;                }
	inline string name_string  (const reduce_unit<velocity>::type&               ){return "atomic unit of velocity";                                     }
	inline string symbol_string(const reduce_unit<velocity>::type&               ){return symbol_string(reduce_unit<length>::type()) + " E_h/ℏ" /*"a₀ E_h/ℏ"*/;         }
	...
	inline string symbol_string(const reduce_unit<frequency>::type&              ){return "E_h/ℏ";}
	inline string symbol_string(const reduce_unit<force>::type&                  ){return "E_h/" + symbol_string(reduce_unit<length>::type()) /*"E_h/a₀"*/;}
...
namespace si{
	...
	inline string symbol_string(const reduce_unit<resistivity>::type&       ){return "Ωm"; /*was "𝛺 m";*/                    }
}}}
#endif
...
namespace nonsi{
	...
	struct angstrom_base_unit : base_unit<angstrom_base_unit, length_dimension, 33485> {
		...
		static const std::string symbol() {return "Å";}
	};
