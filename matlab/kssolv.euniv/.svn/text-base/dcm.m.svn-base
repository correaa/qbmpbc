function [Etotvec, X, vtot, rho] = dcm(mol,options)
%
%
%  Usage: [Etotvec, X, vtot, rho] = dcm(mol);
%
%         [Etotvec, X, vtot, rho] = dcm(mol, options); 
%
%  Purpose:
%     Use trust region enabled direct constrained minization (DCM) 
...
%
%    The following options fields are used by DCM. Check the setksopt 
%    function (by issuing 'help setksopt' to see what values
%    can be set for these fields.
%      
%    option fields used in DCM:
%
