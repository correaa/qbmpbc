...
%
nspin = get(mol,'nspin');
nocc  = getnel(mol)/2*nspin;  if (nocc<1) nocc=0;rho=zeros(n1,n2,n3); end %% <modification by Wei>
%
...
if(nocc>=1) fprintf('norm(HX-XD)     = %11.3e\n', norm(RES(:,1:nocc),'fro')); end %% <modification by Wei>
