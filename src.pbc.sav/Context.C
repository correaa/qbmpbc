...
pimpl_(new ContextImpl(new ContextRep(nprow,npcol))) {
  std::clog<<"Context::Context(int,int) nprow, npcol "<<nprow<<" "<<npcol<<std::endl;
}
...
irstart,icstart))) {
    ...
    std::clog<<"Context::Context(const Context&, int,int,int,int) nprow, npcol "<<nprow<<" "<<npcol<<std::endl;
